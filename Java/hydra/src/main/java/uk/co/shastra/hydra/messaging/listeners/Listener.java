...
public class Listener<TMessage extends TransportMessage> implements IListener<TMessage> {
	...
	public Listener(Provider provider, MessageFetcher<TMessage> messageFetcher)  { this(provider, messageFetcher, null, null, null); }
	public Listener(Provider provider, MessageFetcher<TMessage> messageFetcher, MessageId startId) { this(provider, messageFetcher, startId, null, null); }
    public Listener(Provider provider, MessageFetcher<TMessage> messageFetcher, MessageId startId, ListenerOptions listenerOptions) { this(provider, messageFetcher, startId, listenerOptions, null); }
	/**
     ...
     */
    public Listener(Provider provider, MessageFetcher<TMessage> messageFetcher, MessageId startId, ListenerOptions listenerOptions, Scheduler scheduler)
    {
