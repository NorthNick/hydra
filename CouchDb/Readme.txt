...
1. In Futon create an admin logon with a username and password of your choice. Note that Futon may misbehave in browsers other than Firefox, so it is safest to use that.
